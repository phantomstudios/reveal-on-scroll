...
[list of issues](https://github.com/phantomstudios/reveal-on-scroll/issues).
...
Please send a
[GitHub Pull Request to reveal-on-scroll](https://github.com/phantomstudios/reveal-on-scroll/pull/new/master)
